function IndexView(pTrans, pLayer)
{
	var pDivM = null;
	var pOverview = null;
	this.MapCommand = function(tEvent, pMapBase, hObj)
	{
		if (pDivM == null)
		{
			var pOMap = pMapBase.getHPackage();
			pDivM = pOMap.ownerDocument.createElement("div");
			pOMap.appendChild(pDivM);
			pDivM.style.position = "absolute";
			pDivM.style.right = "0px";
			pDivM.style.bottom = "0px";
			pDivM.style.width = "186px";
			pDivM.style.height = "147px";
			pDiv = pDivM.ownerDocument.createElement("div");
			pDivM.appendChild(pDiv);
			pDiv.style.position = "absolute";
			pDiv.style.right = "0px";
			pDiv.style.bottom = "0px";
			pDiv.style.width = "186px";
			pDiv.style.height = "122px";
			var pImg = pDiv.ownerDocument.createElement("img");
			pDiv.appendChild(pImg);
			pImg.src = "images/030_03.png";
			pImg.style.position = "absolute";
			pImg.style.left = "0px";
			pImg.style.top = "0px";
			var pMDiv = pDiv.ownerDocument.createElement("div");
			pDiv.appendChild(pMDiv);
			pMDiv.style.position = "absolute";
			pMDiv.style.left = "6px";
			pMDiv.style.top = "8px";
			pMDiv.style.width = "174px";
			pMDiv.style.height = "107px";
			pOverview = new Overview(pMDiv, pMapBase, pTrans, "174px", "107px", 4);
